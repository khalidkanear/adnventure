import '../adventure_description_week_based_service_page/widgets/listaimedfor1_item_widget.dart';
                  ...
                  child: Obx(
                    () => ListView.builder(
                      ...
                      itemCount: controller
                          ...
                          .value
                          .listaimedfor1ItemList
                          .length,
                      itemBuilder: (context, index) {
                        Listaimedfor1ItemModel model = controller
                            .adventureDescriptionWeekBasedServiceModelObj
                            .value
                            .listaimedfor1ItemList[index];
                        return Listaimedfor1ItemWidget(
                          model,
                        );
                      },
                    ),
